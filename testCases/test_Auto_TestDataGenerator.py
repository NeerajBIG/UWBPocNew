...
from testCases.common_AI_fxn import ImageReader
...
class Test_DataGenerator:
    ...
    def test_DataGenerator(self, setup):
        scenario_ID = "SC_001"
        ...
        if Enable is True:
            try:
                ...
                time.sleep(1)
                # ---------Clicking Edit Case Button
                self.testStep = "Clicking Edit Case Button"
                self.testPoints = """
                This is step 1.
                This is step 2.
                This is step 3.
                ...
                # Read Image
                path = self.basePath+"\\Screenshots\\"+screenshotName+".png"
                ImageReader.imageReader(self, path)
